  ...
  return await new Promise(async (resolve, reject) => {
    ...
    const resolveWith = (payload) => {
      try {
        ...
        console.warn('[HAWA][stream] onComplete handler failed', error);
      }
      resolve(payload);
    };
    ...
    const rejectWith = (error) => {
      try {
        ...
        console.warn('[HAWA][stream] onError handler failed', handlerError);
      }
      reject(error);
    };
              ...
              if (key === 0) {
                ...
                if (delta && onToken) {
                  try {
                    ...
                    console.warn('[HAWA][stream] onToken handler failed', handlerError);
                  }
                }
              }
            }
